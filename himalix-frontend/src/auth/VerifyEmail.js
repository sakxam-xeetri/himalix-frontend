    ...
    <div className="auth-page">
      ...
      <main className="auth-form-wrap">
        <div className="auth-form-box">
          ...
          {success && (
            <div className="alert alert-success" role="alert" style={{ marginBottom: 'var(--space-5)' }}>
              <i className="fa-light fa-sharp fa-circle-check" /> {success}
            </div>
          )}
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            <div className="form-group">
              <label htmlFor="verify-otp" className="form-label">
                <i className="fa-light fa-sharp fa-key" /> Enter OTP Code
              </label>
              <input
                id="verify-otp"
                name="otp"
                ...
                required
                disabled={loading}
                style={{ textAlign: 'center', fontSize: '20px', letterSpacing: '4px', fontFamily: 'var(--font-mono)' }}
              />
            </div>
